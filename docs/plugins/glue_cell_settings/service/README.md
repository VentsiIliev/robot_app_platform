# `src/plugins/glue_cell_settings/service/` — Glue Cell Settings Service
...
The only file in this plugin allowed to import `ISettingsService` or `IWeightCellService`. Uses settings key `"glue_cells"`.
