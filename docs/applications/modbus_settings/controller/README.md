# `src/applications/modbus_settings/controller/` — Modbus Settings Controller
...
- **No broker subscriptions**: This application does not subscribe to any messaging topics. `stop()` only cleans up threads.
