# `src/robot_apps/glue/settings/` — Glue App Settings Definitions

This package contains all settings dataclasses and serializers specific to the `GlueRobotApp`, plus re-export shims for settings types that live in the engine layer.
