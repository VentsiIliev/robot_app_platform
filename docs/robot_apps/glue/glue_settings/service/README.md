# `src/robot_apps/glue/glue_settings/service/` — Glue Settings Service
...
## `GlueSettingsPluginService`

**File:** `service/glue_settings_plugin_service.py`

```python
class GlueSettingsPluginService(IGlueSettingsService):
