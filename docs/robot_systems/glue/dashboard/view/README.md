# `src/robot_systems/glue/dashboard/view/` — Glue Dashboard View
...
The main production dashboard widget. Extends `IApplicationView` (which extends `AppWidget`). Displays per-cell `GlueMeterCard` widgets and a control row with Start/Stop/Pause/Action buttons.
