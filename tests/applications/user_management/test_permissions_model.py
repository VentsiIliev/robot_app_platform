...
_ROLE_VALUES         = ["Admin", "Operator", "Viewer"]
_DEFAULT_ROLE_VALUES = ["Admin"]
...
def _model(svc, known_app_ids, role_values=None, default_role_values=None):
    return PermissionsModel(
        svc,
        known_app_ids=known_app_ids,
        role_values=role_values if role_values is not None else _ROLE_VALUES,
        default_role_values=default_role_values if default_role_values is not None else _DEFAULT_ROLE_VALUES,
    )
