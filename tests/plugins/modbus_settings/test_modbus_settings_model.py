...
# ---------------------------------------------------------------------------
# ModbusSettingsPluginService — settings only (load/save)
# ---------------------------------------------------------------------------

class TestModbusSettingsPluginService(unittest.TestCase):
    ...
    def test_load_config_reads_correct_key(self):
        ...
        self.assertIs(ModbusSettingsPluginService(ss).load_config(), cfg)
    ...
    def test_save_config_writes_correct_key(self):
        ...
        ModbusSettingsPluginService(ss).save_config(new)
    ...
    def test_service_has_no_detect_ports_method(self):
        ...
        from src.plugins.modbus_settings.service.modbus_settings_plugin_service import ModbusSettingsPluginService
        ss, _ = self._make_ss()
        svc   = ModbusSettingsPluginService(ss)
