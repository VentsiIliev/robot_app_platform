...
from src.robot_apps.glue.glue_settings.model.glue_settings_model import GlueSettingsModel
...
class TestGlueSettingsPluginService(unittest.TestCase):
    ...
    def test_load_settings_reads_correct_key(self):
        from src.robot_apps.glue.glue_settings.service.glue_settings_plugin_service import GlueSettingsPluginService
        ss, cfg, _ = self._make_ss()
        svc = GlueSettingsPluginService(ss)
