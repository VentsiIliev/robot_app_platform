...
from src.robot_apps.glue.glue_settings.controller.glue_settings_controller import GlueSettingsController
...
from src.robot_apps.glue.glue_settings.view.glue_settings_view import GlueSettingsView
