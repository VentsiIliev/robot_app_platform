...
class GlueDashboardModel:
    ...
    def get_cell_capacity(self, cell_id: int) -> float:
        return self._service.get_cell_capacity(cell_id)

    def get_cell_glue_type(self, cell_id: int) -> Optional[str]:
        return self._service.get_cell_glue_type(cell_id)

    def get_all_glue_types(self) -> List[str]:
        return self._service.get_all_glue_types()

    def get_initial_cell_state(self, cell_id: int) -> Optional[Dict]:
        return self._service.get_initial_cell_state(cell_id)
