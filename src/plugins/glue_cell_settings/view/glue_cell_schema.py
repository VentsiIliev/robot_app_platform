...
CONNECTION_GROUP = SettingGroup("Connection", [
    ...
    SettingField("type",                   "Glue Type",              "line_edit",      default="Type A"),
    ...
    SettingField("motor_address",          "Motor Address",          "spinbox",        default=0,      min_val=0,   max_val=255,                step=1),
])
...
MEASUREMENT_GROUP = SettingGroup("Measurement", [
    ...
    SettingField("max_weight_threshold", "Max Weight Threshold", "double_spinbox", default=1000.0, min_val=0.0,  max_val=100000, decimals=1,   suffix=" g",  step=100.0),
])