import logging
from src.engine.vision.implementation.VisionSystem.core.settings.BaseSettings import Settings
...
class CameraSettings(Settings):
    ...
    def updateSettings(self, settings: dict):
        ...
        """
        _logger.info(f"UPDATING CAMERA SETTINGS")
    ...
    def display_settings(self):
        ...
        _logger.info("=== CAMERA SETTINGS ===")

        _logger.info(f"Camera Index: {self.get_camera_index()}")

        _logger.info(f"Resolution: {self.get_camera_width()}x{self.get_camera_height()}")

        _logger.info(f"Skip Frames: {self.get_skip_frames()}")

        _logger.info(f"Capture Position Offset: {self.get_capture_pos_offset()}mm")


        _logger.info("\n=== CONTOUR DETECTION ===")

        _logger.info(f"Threshold: {self.get_threshold()}")

        _logger.info(f"Threshold Pickup Area: {self.get_threshold_pickup_area()}")

        _logger.info(f"Epsilon: {self.get_epsilon()}")

        _logger.info(f"Min Contour Area: {self.get_min_contour_area()}")

        _logger.info(f"Max Contour Area: {self.get_max_contour_area()}")

        _logger.info(f"Contour Detection: {self.get_contour_detection()}")

        _logger.info(f"Draw Contours: {self.get_draw_contours()}")


        _logger.info("\n=== PREPROCESSING ===")

        _logger.info(f"Gaussian Blur: {self.get_gaussian_blur()}")

        _logger.info(f"Blur Kernel Size: {self.get_blur_kernel_size()}")

        _logger.info(f"Threshold Type: {self.get_threshold_type()}")

        _logger.info(f"Dilate Enabled: {self.get_dilate_enabled()}")

        _logger.info(f"Dilate Kernel: {self.get_dilate_kernel_size()}, Iterations: {self.get_dilate_iterations()}")

        _logger.info(f"Erode Enabled: {self.get_erode_enabled()}")
        ...
        _logger.info(f"Square Size: {self.get_square_size_mm()}mm")

        _logger.info(f"Calibration Skip Frames: {self.get_calibration_skip_frames()}")


        _logger.info("\n=== BRIGHTNESS CONTROL ===")

        _logger.info(f"Auto Brightness: {self.get_brightness_auto()}")

        _logger.info(

            f"PID Values - Kp: {self.get_brightness_kp()}, Ki: {self.get_brightness_ki()}, Kd: {self.get_brightness_kd()}")
        _logger.info(f"Target Brightness: {self.get_target_brightness()}")


        _logger.info("\n=== ARUCO DETECTION ===")

        _logger.info(f"ArUco Enabled: {self.get_aruco_enabled()}")

        _logger.info(f"Dictionary: {self.get_aruco_dictionary()}")

        _logger.info(f"Flip Image: {self.get_aruco_flip_image()}")
