...
def build_glue_workpiece_form_schema(glue_types=None,tools=None) -> WorkpieceFormSchema:
    glue_types = glue_types or ["Type A", "Type B"]
    tool_options = tools or []
    return WorkpieceFormSchema(
        ...
        fields=[
            ...
            WorkpieceFormFieldSpec(key=GlueWorkpieceField.GRIPPER_ID.value,   label="Gripper",       field_type="dropdown", mandatory=False, options=tool_options, icon=GRIPPER_ID_ICON),
