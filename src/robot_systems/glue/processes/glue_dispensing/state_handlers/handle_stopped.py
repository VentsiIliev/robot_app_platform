...
def handle_stopped(context) -> GlueDispensingState:
    ...
    try:
        ...
        _logger.exception("stop_motion failed in STOPPED handler")
    ...
    if context.motor_started and context.spray_on and context.pump_controller:
        ...
        if motor_address != -1:
            try:
                ...
                _logger.exception("pump_off failed in STOPPED handler")
    ...
    if context.generator_started and context.generator is not None:
        try:
            ...
            _logger.exception("generator turn_off failed in STOPPED handler")
