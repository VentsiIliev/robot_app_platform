...
from src.robot_systems.glue.applications.dashboard.ui.factories.glue_card_factory import GlueCardFactory
...
from src.robot_systems.glue.applications.dashboard import config
...
class GlueDashboard:
    ...
    def create(
        ...
        service = GlueDashboardService(
            ...
            preview_transformer_getter=preview_transformer_getter,
        )
