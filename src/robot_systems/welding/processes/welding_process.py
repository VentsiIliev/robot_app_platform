...
class WeldingProcess(BaseProcess):
    ...
    def _on_start(self) -> None:
        self._logger.info("WeldingProcess started — simulating %.1fs of work", self._simulation_duration_s)
        self._start_timer()

    def _on_stop(self) -> None:
        self._cancel_timer()
        self._logger.info("WeldingProcess stopped")

    def _on_pause(self) -> None:
        self._cancel_timer()
        self._logger.info("WeldingProcess paused")

    def _on_resume(self) -> None:
        self._logger.info("WeldingProcess resumed — simulating %.1fs of work", self._simulation_duration_s)
        self._start_timer()

    def _on_reset_errors(self) -> None:
        self._cancel_timer()
        self._logger.info("WeldingProcess reset errors")
    ...
    def _complete(self) -> None:
        self._logger.info("WeldingProcess simulation complete — stopping")
        self.stop()
