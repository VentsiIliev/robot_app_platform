...
from src.robot_systems.welding.height_measuring.mock_laser_control import (
    MockLaserControl,
)


class WeldingRobotSystemHeightMeasuringProvider(RobotSystemHeightMeasuringProvider):
