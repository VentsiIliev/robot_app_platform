...
class PaintRobotSystemTargetingProvider(RobotSystemTargetingProvider):
    ...
    def _targeting_settings(self):
        ...
        return getattr(self._robot_system, "_paint_targeting", None)
    ...
    def build_point_registry(self):
        return build_paint_point_registry(self._point_definitions())
    ...
    def build_frames(self):
        ...
        return build_paint_target_frames(
