...
# Map UI Speed 1..100 onto this internal Velocity minimum..100. With 10,
# UI Speed 1 resolves like the previous Speed 10 (Velocity 10, Acceleration 1).
COMBINED_PAINT_SPEED_MINIMUM_PERCENT = 10.0
COMBINED_PAINT_SPEED_MAXIMUM_PERCENT = 100.0
