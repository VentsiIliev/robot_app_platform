...
class PaintProcessSettingsMapper:
    ...
    def to_flat_dict(settings: PaintProcessConfig) -> dict:
        ...
        return {
            ...
            "pickup_servo_contact_retract_maximum_distance_mm": pickup.servo_contact_retract_maximum_distance_mm,
    ...
    def from_flat_dict(flat: dict, base: PaintProcessConfig) -> PaintProcessConfig:
        ...
        pickup = replace(
            ...
            servo_contact_retract_maximum_distance_mm=float(
                flat.get(
                    "pickup_servo_contact_retract_maximum_distance_mm",
                    base.pickup_motion.servo_contact_retract_maximum_distance_mm,
                )
            ),
