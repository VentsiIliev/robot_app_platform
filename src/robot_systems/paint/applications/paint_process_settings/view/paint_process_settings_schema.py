...
def build_process_groups() -> list[SettingGroup]:
    return [
        ...
        SettingGroup(_t("Servo Contact Settings"), [
            ...
            _mm_per_second_field("pickup_servo_contact_retract_final_linear_mm_s", "Final Servo Retract Speed", 50.0),
            _mm_field("pickup_servo_contact_retract_slowdown_clearance_mm", "Retract Slowdown Clearance", 20.0, min_val=2.1),
            _mm_field("pickup_servo_contact_retract_safety_margin_mm", "Servo Retract Safety Margin", 10.0, min_val=0.0),
