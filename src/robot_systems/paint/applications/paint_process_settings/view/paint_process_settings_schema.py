    ...
    return [
        ...
        SettingGroup(_t("Dropoff Strategy"), [
            ...
            SettingField(
                ...
                _t("Plate Passage Gate Pose"),
                "paint_waypoint_table",
                default={"vel_percent": 70.0, "acc_percent": 50.0},
            ),
            _toggle("dropoff_plate_use_entry_gate_as_detach_pose", "Use Plate Entry as Paint Detach Pose"),
            SettingField(
        ...
        SettingGroup(_t("Magazine Load"), [
            ...
            _mm_field("magazine_full_retract_z_mm", "Full Retract Z", 120.0),
        ...
        SettingGroup(_t("Sensor-Controlled Fast LIN"), [
            ...
            SettingField(
                ...
                decimals=2,
                suffix=" s",
                step_options=[0.05, 0.10, 0.20],
            ),
            SettingField(
                "pickup_servo_contact_stop_confirmation_timeout_s",
                _t("Stop Confirmation Timeout"),
                "double_spinbox",
                default=3.0,
                min_val=0.1,
                max_val=10.0,
            ...
            _count_field(
                ...
                "Magazine Post-Retract Confirmation Samples",
                2,
            ),
            SettingField(
                "pickup_magazine_post_retract_confirmation_interval_s",
                _t("Magazine Post-Retract Sample Interval"),
                "double_spinbox",
                default=0.05,
                min_val=0.0,
                max_val=1.0,
