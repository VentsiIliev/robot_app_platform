...
VISION_CALIBRATION_GROUP = SettingGroup("Camera Calibration", [
    ...
    SettingField("calib_vision_reference_board_mode", "Reference Board Mode", "combo",
                 default="auto", choices=["auto", "charuco", "chessboard"]),
    SettingField("calib_vision_charuco_board_width", "ChArUco Width", "spinbox",
                 default=0, min_val=0, max_val=80, step=1),
    SettingField("calib_vision_charuco_board_height", "ChArUco Height", "spinbox",
                 default=0, min_val=0, max_val=80, step=1),
    SettingField("calib_vision_charuco_square_size_mm", "ChArUco Square Size", "double_spinbox",
                 default=0.0, min_val=0.0, max_val=200.0, step=0.5, decimals=1,
                 suffix=" mm", step_options=[0.5, 1.0, 5.0]),
    SettingField("calib_vision_charuco_marker_size_mm", "ChArUco Marker Size", "double_spinbox",
                 default=0.0, min_val=0.0, max_val=200.0, step=0.5, decimals=1,
                 suffix=" mm", step_options=[0.5, 1.0, 5.0]),
