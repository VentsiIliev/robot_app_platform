...
PREPROCESSING_GROUP = SettingGroup("Preprocessing", [
    ...
    SettingField("contour_smoothing_mode", "Contour Smoothing", "combo",
                 default="none",
                 choices=["none", "moving_average", "savgol"]),
    SettingField("contour_smoothing_strength", "Smoothing Strength", "double_spinbox",
                 default=5.0, min_val=0.0, max_val=25.0, step=1.0, decimals=1,
