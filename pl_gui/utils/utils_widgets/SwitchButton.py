...
class QToggle(QCheckBox):
    ...
    def __init__(self, parent=None):
        ...
        self._bg_color, self._circle_color, self._active_color, \
            self._disabled_color, self._text_color = QColor("#666"), \
            QColor("#DDD"), QColor('#905BA9'), QColor("#666"), QColor("#000")
...
if __name__ == '__main__':
    ...
    checkbox2.setDuration(300)  # Set animation duration to 300 ms
